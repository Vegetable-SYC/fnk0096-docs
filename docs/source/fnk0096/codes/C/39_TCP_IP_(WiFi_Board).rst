...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_00.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_01.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_02.png
    :align: center

Unzip the downloaded file to your computer. Click "processing.exe" as the figure below to run this software.

.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_03.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_06.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_07.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_09.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_11.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_12.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_13.png
    :align: center
...
.. literalinclude:: ../../../freenove_Kit/Sketches/Sketch_39.1.1_WiFiClient/Sketch_39.1.1_WiFiClient.ino
    :linenos: 
    :language: c
    :lines: 11-12
    :dedent:
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_14.png
    :align: center

Compile and upload code to control board(wifi) , open the serial monitor and set the baud rate to 115200. Turn on server mode for control board(wifi), waiting for the connection of other devices on the same LAN. Once a device connects to server successfully, they can send messages to each other.

If the control board(wifi) fails to connect to router, press the reset button as shown below and wait for control board(wifi) to run again.

.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_15.png
    :align: center

Serial Monitor

.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_17.png
    :align: center
...
.. image:: ../_static/imgs/39_TCP_IP_(WiFi_Board)/Chapter39_16.png
    :align: center

The following is the program code:

.. literalinclude:: ../../../freenove_Kit/Sketches/Sketch_39.2.1_WiFiServer/Sketch_39.2.1_WiFiServer.ino
    :linenos: 
    :language: c
    :lines: 1-53
    :dedent:
